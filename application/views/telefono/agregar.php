<div class="row static-content" role="main" style="margin-top:-40px;">
    ...
    <div class="modal_container">
        <div class="large-12 columns ">
            <h2>Agregar Teléfonos</h2>
            <?php if ($this->session->flashdata('message')) : ?>
                <p><?php echo $this->session->flashdata('message') ?></p>
            <?php endif; ?>

            <form class="form-horizontal" action="/telefono/agregar" method="post">
                ...
                <div class="control-group">
                    <label class="control-label" for="banco">Tipo</label>
                    <div class="controls">
                        <select name="tipo">
                            <option value="">--Seleccionar--</option>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="submit" class="btn btn-primary" value="Agregar Teléfono"/> 
                    </div>
                </div>
            </form>
            <?php if ($_GET['m']) { ?>
                <?php if ($_GET['m'] == 1) { ?>
                    <div class=""><p>Teléfono guardado correctamente</p></div>
                <?php } ?>
            <?php } ?>
        </div>
    </div>
